...
import { DepWindow } from '../Components/window'
export const Header = () => {
    useEffect(() => {
        AOS.init();
    }, [])
                                                ...
                                                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-gray-100 outline-none focus:outline-none">
                                                    <div className="relative p-6 flex-auto">
                                                        <div className="rounded-lg px-8 pb-8 w-full">
                                                            ...
                                                            <div className=''>
                                                                <button className='mt-8 shadow flex gap-2 bg-blue-400 hover:bg-blue-500 text-tt font-bold py-2 px-4 rounded  transition duration-300 ease-in-out hover:scale-110' onClick={metamask}>
